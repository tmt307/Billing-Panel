...
<h3> Account Information </h3>
    ...
    <div class="uk-margin">
        <div class="uk-inline">
            ...
            <input class="uk-input uk-form-width-large" type="text" value="" placeholder="Full Name" >
        </div>
    </div>
...
<div class="uk-margin">
   <select class="uk-select uk-form-width-large" placeholder="Country">
    ...
    <div class="uk-margin">
        <div class="uk-margin">
            <textarea class="uk-textarea  uk-form-width-large" rows="5" placeholder="Admin Notes"></textarea>
        </div>
    </div>
</div>
