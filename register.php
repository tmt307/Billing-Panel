...
$stmt->execute(array(":email_id"=>$email_address));
...
if($reg_user->register($username,$email_address,$password,$code))
{
    ...
    $message = "
                Hello $username,
                <br /><br />
                Welcome to Fitness Planner!<br/>
                To complete your registration  please , just click following link<br/>
                <br /><br />
                <a href='http://fitnessplanner.net/new/verify.php?id=$id&code=$code'> Click here to activate your account.</a>
                <br /><br />
                Thanks,";
        ...
        <div class="uk-width-1-1@m">
            <div class="uk-margin uk-width-large uk-margin-auto uk-card uk-card-secondary uk-card-body uk-box-shadow-large">
                ...
                <form method="post">
                    <fieldset class="uk-fieldset">
                        ...
                        <div class="uk-margin">
                            <div class="uk-position-relative">
                                ...
                                <input name="username" class="uk-input" type="text" placeholder="Enter a username">
                            </div>
                        </div>
                        ...
                        <div class="uk-margin">
                            <div class="uk-position-relative">
                                ...
                                <input name="email_address" class="uk-input" type="email" placeholder="Enter an email address">
                            </div>
                        </div>
                    ...
                    <div class="uk-margin">
                            <div class="uk-position-relative">
                                <span class="uk-form-icon" u-icon="icon: lock"></span>
                                <input type="password" name="confirm_password" class="uk-input" type="password" placeholder="Confirm your password">
                            </div>
                        </div>
